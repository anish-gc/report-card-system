    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.CharField(db_index=True, help_text='Unique student identification number', max_length=20, unique=True, validators=[django.core.validators.RegexValidator(message='Student ID must be 6-20 characters, alphanumeric uppercase only', regex='^[A-Z0-9]{6,20}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generated_at', models.DateTimeField(auto_now_add=True, help_text='When the report card was generated')),
                ('is_published', models.BooleanField(db_index=True, default=False, help_text='Whether the report card is published to students')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddIndex(
            model_name='reportcard',
            index=models.Index(fields=['year', 'is_published'], name='report_card_year_5c8a33_idx'),
        ),
