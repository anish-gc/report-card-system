# Generated by Django 5.2.5 on 2025-08-08 15:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(blank=True, choices=[('A+', 'A+'), ('A', 'A'), ('B+', 'B+'), ('B', 'B'), ('C+', 'C+'), ('C', 'C'), ('D', 'D'), ('F', 'F')], help_text='Letter grade based on average score', max_length=2, null=True)),
                ('percentage', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Percentage score', max_digits=5)),
                ('calculation_status', models.CharField(choices=[('pending', 'Pending'), ('calculating', 'Calculating'), ('completed', 'Completed'), ('failed', 'Failed')], default='pending', help_text='Status of background calculations', max_length=20)),
                ('last_calculated', models.DateTimeField(blank=True, help_text='When calculations were last completed', null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddIndex(
            model_name='reportcard',
            index=models.Index(fields=['calculation_status'], name='report_card_calcula_3a46a5_idx'),
        ),
